            ...
            <div class="b_oatmeal p50all">
                ...
                <div class="content">
                    <div class="list">
                        ...
                        <p>
                            게시판과 뉴스를 작성하고 각각의 아이디를 받아와 불러오고 수정 / 삭제가 가능하도록 만들었다. route.js와 db.js가 넘겨주고 받아오는 바인딩 작업을 하였다. db.js에서 select from같은 구문을 사용하여 데이터를 저장하고 불러주는 작업을 통해 게시판은 가장 최근에 작성된 것 4가지가 메인페이지에서 보여질 수 있도록 만들었고, 카테고리를 정하면 카테고리에 해당하는 색이 보여지도록 설정해주었다.
                        </p>
                        <p class="bold comple"> 보완해야 할 점</p>
                        <p></p>
                    </div>
                    <div class="list">
                        <h3 class="apple">예약페이지</h3>
                        <p>
                          원하는 축제 이름과,날짜,시간대,예약자 이름 그리고 전화번호를 입력하면 예약확인 페이지로 넘어가게끔 만들었다.
                          예약확인 페이지에서 한번 정보들을 확인 할 수 있도록 데이터베이스 연결을 해주었다 
                        </p>
                        <p class="bold comple"> 보완해야 할 점</p>
                    ...
                    <div class="list">
                        ...
                        <p>메인 페이지의 가장 하단의 이벤트 섹션을 통해 들어갈 수 있고 댓글을 남기면 추첨을 통해 선물을 드린다는 이벤트 형삭이다. 데이터 베이스 연결로 아이디 비밀번호 댓글 내용을 받아와서 화면에는 아이디 내용 작성 날짜만 뜨도록 구현해주었다.</p>
                        <p class="bold comple">보완해야 힐 점
                        </p>
                        <p>로그인한 상태를 인식하게 만든다면 불필요하게 아이디 비밀번호를 넣지 않아도 될 것이다. 댓글 작성시 현재 저장되어있는 아이디를 불러올 수 있는 방법으로 보완하면 좋을 것 같다. </p>
                    </div>
                    <div class="list">
